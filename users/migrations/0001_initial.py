    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('buyer', 'Comprador'), ('seller', 'Vendedor')], max_length=10, null=True)),
                ('ofrece_servicios', models.BooleanField(default=False)),
                ('bio', models.TextField(blank=True)),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='profiles/')),
                ('cuit_cuil', models.CharField(blank=True, max_length=20, null=True)),
